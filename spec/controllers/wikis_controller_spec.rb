...
RSpec.describe WikisController, type: :controller do
  describe "GET index" do
    ...
    context "User is logged in" do
      ...
      login_user
      let(:my_wiki) { Wiki.create!(title: "New Test Wiki", body: "New Wiki Body", private: false) }
  ...
  describe "POST create" do
    ...
    it "increases the number of wikis by 1" do
      expect{ post :create, wiki: {title: Faker::Lorem.sentence(1), body: Faker::Lorem.paragraph(2), private: false}}.to change(Wiki,:count).by(1)
    end

    it "assigns the new wiki to @wikis" do
      post :create, wiki: {title: Faker::Lorem.sentence(1), body: Faker::Lorem.paragraph(2), private: false}
